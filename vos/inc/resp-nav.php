<nav><div class="menu-btn"><img src="/img/btn-hamburger.png" alt=""></div>
			<ul class="menu">
  
                  <li class="menu-item"><a class="menu-button" href="#">CLOTHING</a>
					<ul>
						<li><a class="sub" href="/shirts">SHIRTS</a></li>
						<li><a class="sub" href="/caps">CAPS</a></li>
						
					</ul>
				  </li>
                  <li class="menu-item"><a class="menu-button" href="#">PRINT</a>
				  <ul>
						<li><a class="sub" href="/prints">SCREEN PRINTS</a></li>
						<li><a class="sub" href="/accessories/stickers.html">STICKERS</a></li>
					</ul>
				  </li>
				           <li class="menu-item"><a href="/about">ABOUT</a></li>
							...
							<li class="vos-social-buttons"><a href="http://vikingsofskate.tumblr.com/" target="_blank">
									<img onmouseover="this.src='/img/icons/social/tumblr-rollover.png'"  height="20" width="20" onmouseout="this.src='/img/icons/social/tumblr.png'" border="0" src="/img/icons/social/tumblr.png" alt="Tumblr" /></a></li>		
